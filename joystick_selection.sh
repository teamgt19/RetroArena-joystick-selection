...
#               if you have RetroArena installed, the you have inifuncs
#               at /opt/retroarena/lib/inifuncs.sh).
#   runcommand: actually the dependency is the runcommand-onstart feature.
#               This feature was added to the RetroArena's runcommand script
...
source "/opt/retroarena/supplementary/joystick-selection/jsfuncs.sh"
...
jsonmenu="/opt/retroarena/configs/all/runcommand-menu/select joystick.sh"
if [[ ! -s "$jsonmenu" ]]; then
