...
readonly rootdir="/opt/retroarena"
...
# getting some usefull functions from RetroArena
...
The joystick selection by name method depends on an updated version of RetroArena's runcommand.

You must update it via retroarena_setup.sh to use joystick selection by name method.

Short way: execute retroarena_setup.sh and choose \"Update RetroArena-Setup script\". And then go to
